...
if(isset($_POST['submit'])) {
    ...
    $generatioal_groups = 'MF';

    $sql = "INSERT INTO Members (MemberID, Title, First_Name, Last_Name, Gender, Telephone_Nos, Whatsapp_No, Generational_Groups)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
...
?>
                ...
                <div class="container">
        <h2 class="text-center">Men's Fellowship Form</h2>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                <label for="Whatsapp_No">WhatsApp_Nos:</label>
                <input type="text" name="Whatsapp_No" class="form-control">
            </div>

            <div class="form-group col-md-3">
                <label for="Generational_Groups">Generational_Groups:</label>
                <input type="text" name="Generational_Groups" class="form-control" value="Men's Fellowship" readonly>
            </div>
