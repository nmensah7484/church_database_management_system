...
if(isset($_POST['submit'])) {
    ...
    $service_groups = 'PAROUSIA VOICES';
...
?>
                ...
                <div class="container">
        <h2 class="text-center"> Parousia Voices Form</h2>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" name="Service_Groups" class="form-control" value="Parousia Voices" readonly>
            </div>
