...
?>
                <div class="container">
        <h2 class="text-center">Church Choir Form</h2>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" name="Service_Groups" class="form-control" value="Church Choir" readonly>
            </div>
