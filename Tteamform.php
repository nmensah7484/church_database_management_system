...
if(isset($_POST['submit'])) {
    ...
    $service_groups = 'AUDIO VISUAL TEAM';
...
?>
                ...
                <!-- End of Topbar -->
                <div class="container">
        <h2 class="text-center">Technical Team Form</h2>
        <form action="" method="post" class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" name="Service_Groups" class="form-control" value="AUDIO VISUAL TEAM" readonly>
            </div>
