...
<head>
    ...
    <title>Inventory Table - Database</title>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/editor/2.0.8/css/editor.dataTables.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/editor/2.0.8/css/editor.dataTables.min.css">
...
<body id="page-top">
  ...
  .buttons-pdf,
  .buttons-excel {
    background-color: #e53935; /* Red background color for PDF */
    border: none;
    color: white;
    padding: 10px 20px;
    text-align: center;
  ...
  .buttons-pdf:hover,
  .buttons-excel:hover {
    background-color: #c62828; /* Darker red on hover for PDF and Excel */
  }
            ...
            <tbody>
                ...
                while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
                    ...
                    if ($row['DateAdded'] instanceof DateTime) {
                        echo "<td>" . $row['DateAdded']->format('Y-m-d') . "</td>";
                    } else {
  ...
  <script src="https://cdn.datatables.net/editor/2.0.8/js/dataTables.editor.min.js"></script>
