...
if(isset($_POST['submit'])) {
    ...
    $service_groups = 'BSPG/PRAYER TOWER';

    $sql = "INSERT INTO Members (MemberID, Tilte, First_Name, Last_Name, Gender, Telephone_Nos, Whatsapp_No, service_Groups)
            VALUES (?, ?, ?, ?, ?, ?, ? ,?)";
    $stmt = sqlsrv_prepare($conn, $sql, array($memberid, $title, $first_name, $last_name, $gender, $telephone_nos, $whatsapp_no, $service_groups));
...
?>
                ...
                <div class="container">
        <h2 class="text-center">BSPG Form</h2>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                <label for="Service_Groups">Service_Groups:</label>
                <input type="text" name="Service_Groups" class="form-control" value="BSPG/Prayer Tower" readonly>
            </div>
