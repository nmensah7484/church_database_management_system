...
if(isset($_POST['submit'])) {
    ...
    $service_groups = 'SESSION MEMBER';

    $sql = "INSERT INTO Members (MemberID, Title, First_Name, Last_Name, Gender, Telephone_Nos, Whatsapp_No, Service_Groups)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
...
?>
                ...
                <div class="container">
        <h2 class="text-center">Session Members Form</h2>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" name="Service_Groups" class="form-control" value="Session Member" readonly>
            </div>
